 ...
 */
   ...
   public function getInfosVisiteur($login,$mdp)
   {
       // retourne les informations sur le visiteur (la table utilisateur)
         $req="select nom, prenom from utilisateur where login='".$login."' and password='".$mdp."'";
   ...
   public function getLesProjets() 
   {
    ...
    {
     // retourne un tableau associatif contenant tous les employés
    ...
    {
     // retourne un tableau associatif contenant tous les projets avec les employés associés
         $req="select nom, prenom, p.codeprojet, nomprojet, dureeprevue from employeinformaticien e, projet p WHERE e.codeprojet = p.codeprojet;";
         $rs = PdoExemple::$monPdo->query($req);
		$ligne = $rs->fetchAll(PDO::FETCH_ASSOC);
		return $ligne;
        // ou return $this->_pdo->query($query)->fetchAll(PDO::FETCH_ASSOC);
